...
function ScrollBar(props) {
    ...
    useEffect(()=>{
        ...
        props.scrollArea.current.onwheel = (e)=>{
            ...
            if((delta < props.contentMaxDeltaY) && e.deltaY > 0) {
                ...
                setDelta( props.contentMaxDeltaY);
            } 
    ...
    },[delta, scrollBarHeight, scrollerHeight, scrollerMaxDeltaY, maxScrollerBottom, minScrollerBottom])
    ...
    return(
        <div  ref = {scrollBar} className = 'scroll'>
            <div ref = {upArrow}  className="up-arrow" onClick={()=>{
                ...
                // } 
                // if(delta !== 0) {setDelta( delta - displasmentByClick)}
                // console.log('delta = ' + delta);
                // console.log('scrollTop = ' + props.container.current.scrollTop);
                // console.log('contentMaxDeltaY = ' + props.contentMaxDeltaY);
                // console.log('case - 3')  
            ...
            <div ref = {downArrow} className="down-arrow" onClick={()=>{
                ...
                //     console.log('case - 2')
                // } 
                // setDelta( delta + displasmentByClick);
                // if(delta >= props.contentMaxDeltaY) {setDelta( props.contentMaxDeltaY)}
                // console.log('delta = ' + delta);
                // console.log('case - 3')
                }}
                onMouseOver = {(e)=>{
