...
export let ingredients = [
    'Добавить ингридиент', 'Абсент', 'Водка', 'Джин', 'Виски', 'Бренди', 'Кальвадос', 'Вода', 'Сироп', 'Ликёр', 'Текила','Ром', 'Коньяк', 'Вино', 'Мартини'
]
...
export let tags = ['Овощные', 'Огненные', 'Освежающие', 'Пикантные', 'Пунш', 'С мороженым', 'Сладкие', 'Солёные', 'Острые', 'Крепкие','Со льдом', 'С украшением', 'Крепкие', 'Мятные'];
